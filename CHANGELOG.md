...
## [2.1.2] - 2026-08-13
### Changed
- Updated `sirix/container-resolver` to ^1.0.

## [2.1.1] - 2026-08-10
### Changed
- Updated `sirix/container-resolver` to ^0.2 and migrated logger resolution to its `optionalExisting()` API.
- Updated `sirix/redaction` to 2.1.1 for compatibility with `sirix/container-resolver` 0.2.
